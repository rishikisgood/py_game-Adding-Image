...
pygame.display.set_caption('Adding imape and background image')
background_image=pygame.transform.scale(pygame.image.load('downlod.0.png').convert(), (SCREEN_WIDTH, SCREEN_HIGHT))
penguin_image=pygame.transform.scale(pygame.image.load('hello penguin.png').convert_alpha(), (200, 200))
penguin_rect=penguin_image.get_rect(center=(SCREEN_WIDTH//2, SCREEN_HIGHT//2-30))
